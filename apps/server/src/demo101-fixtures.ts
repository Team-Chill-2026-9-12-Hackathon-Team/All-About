...
export const demo101Sources = [
  {
    ...
    entryUrl: "https://fixture.example.edu/demo101/syllabus",
    allowedHosts: ["fixture.example.edu"],
    scope: demo101Scope,
    contentMode: "fixture",
    access: "public",
  },
  {
    ...
    entryUrl: "https://fixture.example.edu/demo101/announcement",
    allowedHosts: ["fixture.example.edu"],
    scope: demo101Scope,
    contentMode: "fixture",
    access: "public",
  },
  {
    ...
    entryUrl: "https://fixture.example.edu/demo101/discussion",
    allowedHosts: ["fixture.example.edu"],
    scope: demo101Scope,
    contentMode: "fixture",
    access: "public",
...
const pages: Record<string, Omit<PageSnapshot, "id" | "fetchedAt">> = {
  "demo101-syllabus": {
    ...
    text: "Demo data · Fictional course. The assignment is due September 18, 2026 at 17:00 America/Toronto. Submit one PDF.",
  ...
  "demo101-announcement": {
    ...
    text: "Demo data · Fictional course. Instructor announcement: the assignment is extended and now due September 20, 2026 at 17:00 America/Toronto. Submit one PDF. All other submission requirements remain unchanged.",
